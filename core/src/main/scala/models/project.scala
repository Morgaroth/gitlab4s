...
case class ProjectInfo(
    ...
    monitor_access_level: Option[String],
    infrastructure_access_level: Option[String],
    model_experiments_access_level: Option[String],
    feature_flags_access_level: Option[String],
    model_registry_access_level: Option[String],
